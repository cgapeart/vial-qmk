...
bool sjsb = 0;
// LED mappings
led_config_t g_led_config = {{// Key Matrix Postion to LED index
                              {0, 5, 10, 15, 21, 27, 32},
                              {1, 6, 11, 16, 22, 28, 33},
                              {2, 7, 12, 17, 23, 29, 34},
                              {3, 8, 13, 18, 24, 30, 35},
                             ...
                             {// LED Index to physical position
                              {0, 2}, {0, 9}, {1, 17}, {1, 25}, {1, 33}, {11, 1}, {12, 9}, {12, 17}, {13, 25}, {13, 33}, {22, 1}, {23, 8}, {24, 16}, {24, 25}, {24, 33}, {34, 1}, {35, 8}, {36, 16}, {36, 25}, {36, 33}, {36, 41}, {46, 0}, {47, 7}, {47, 15}, {48, 23}, {48, 32}, {48, 40}, {57, 1}, {57, 8}, {58, 16}, {58, 25}, {58, 33}, {68, 1}, {68, 9}, {69, 17}, {69, 25}, {69, 33}, {64, 47}, {73, 57}, {76, 64}, {77, 47}, {85, 55}, {88, 61}, {224, 2}, {223, 9}, {222, 17}, {222, 25}, {222, 33}, {212, 1}, {211, 9}, {211, 17}, {210, 25}, {210, 33}, {201, 1}, {200, 8}, {199, 16}, {199, 25}, {199, 33}, {188, 1}, {188, 8}, {187, 16}, {187, 25}, {187, 33}, {187, 41}, {177, 0}, {176, 7}, {176, 15}, {175, 23}, {175, 32}, {175, 40}, {166, 1}, {166, 8}, {165, 16}, {165, 25}, {165, 33}, {155, 1}, {155, 9}, {154, 17}, {154, 25}, {154, 33}, {159, 47}, {150, 57}, {147, 64}, {146, 47}, {138, 55}, {135, 61}},
                             {// key flags
                              LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT,
                              LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT}};
...
void housekeeping_task_user(void) {
    ...
    if (is_keyboard_master())
    {
        ...
        if (timer_elapsed32(last_sync) > SPLIT_JS_SAMPLE_MS)
        {
            ...
            joystick_set_axis(0, map(mx,0,1024,-512,512));
            joystick_set_axis(1, map(my,0,1024,512,-512));
            ...
            if (transaction_rpc_exec(JOYSTICK_SYNC, sizeof(master_to_slave_t), &m2s, sizeof(slave_to_master_t), &s2m))
            {
                ...
                joystick_set_axis(2, map(sx,0,1024,512,-512));
                joystick_set_axis(3, map(sy,0,1024,-512,512));
